...
<head>
    ...
    <link rel="stylesheet" href="${request.contextPath}/static/plugins/ace/styles.css" type="text/css" media="screen" charset="utf-8">
    <script async="true" src="https://use.edgefonts.net/source-code-pro.js"></script>

    <link href="${request.contextPath}/static/plugins/ace/favicon.ico" rel="icon" type="image/x-icon">
</head>
<body>
<div id="optionsPanel" style="position:absolute;height:100%;width:260px">
  <a href="http://c9.io" title="Cloud9 IDE | Your code anywhere, anytime">
    <img id="c9-logo" src="${request.contextPath}/static/plugins/ace/logo.png" style="width: 172px;margin: -9px 30px -12px 51px;">
  </a>
  ...
  <a href="http://ace.c9.io">
    <img id="ace-logo" src="${request.contextPath}/static/plugins/ace/ace-logo.png" style="width: 134px;margin: 46px 0px 4px 66px;">
  </a>
  </div>
  </div>
  </div>
...
<script type="text/javascript">
  ...
  var require = {
      baseUrl: '${request.contextPath}/static/plugins/ace/',
          paths: {
              ace: "lib/ace"
          },
          waitSeconds: 30
...
<script src="${request.contextPath}/static/plugins/requirejs/requirejs.2.1.22.min.js" data-main="${request.contextPath}/static/plugins/ace/demo.js" ></script>
<!--DEVEL-->
