...
<head>
    ...
    <link rel="stylesheet" href="${request.contextPath}/static/js/ace-demo2/styles.css" type="text/css" media="screen" charset="utf-8">
</head>
<body>
<!-- 左侧Setting -->
...
<script src="${request.contextPath}/static/plugins/requirejs/requirejs.2.1.22.min.js" data-main="${request.contextPath}/static/js/code.editor.js" ></script>
