...
define(function(require, exports, module) {
	...
	require("ace-demo2/inline_editor");
	require("ace-demo2/dev_util");
	require("ace-demo2/file_drop");
	...
	var doclist = require("ace-demo2/doclist");
	var modelist = require("ace/ext/modelist");
	var themelist = require("ace/ext/themelist");
	var layout = require("ace-demo2/layout");
	var TokenTooltip = require("ace-demo2/token_tooltip").TokenTooltip;
	var util = require("ace-demo2/util");
...
border:1px solid #baf; z-index:100";
	...
	cmdLine.commands.removeCommands([ "find", "gotoline", "findall", "replace",
			"replaceall" ]);
	...
	commands.addCommand({
		...
		exec : function(arg) {
			...
			if (typeof value == "string") {
				...
				env.editor.cmdLine.setValue("no previuos value saved for "
						+ name);
			}
		}
	});
	...
	var highlightSelectedWordE = document
			.getElementById("highlight_selected_word");
	...
	bindDropdown("mode", function(value) {
		env.editor.session.setMode(modesByName[value].mode
				|| modesByName.text.mode);
	...
	function updateUIEditorOptions() {
		...
		saveOption(wrapModeEl, session.getUseWrapMode() ? session
				.getWrapLimitRange().min
				|| "free" : "off");
	...
	env.editor.addEventListener('incrementalSearchSettingChanged', function(
			event) {
